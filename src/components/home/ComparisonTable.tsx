...
const DEFAULT_FEATURES: FeatureRow[] = [
  ...
  },
  {
    ...
    maxracing: "Rotary steering stabilizer mounted in the stem/handlebar area using bike-specific brackets; the kit may be under- or over-bar depending on clearance.|FAQ:/faq",

    ohlins: "Linear hydraulic steering damper (shaft + piston in a cylinder), typically mounted across the front end using model- or kit-specific brackets.|Öhlins:https://ohlins.pl/sites/default/files/om_07261-01.pdf",
    hyperpro: "Linear hydraulic steering damper range; RSC models function as a linear damper in normal riding with an adjustable damping circuit.|Hyperpro:https://hyperpro.com/steering-dampers/",
    gpr: "Rotary steering stabilizer mounted in the stem/handlebar area, supplied as bike-specific kits with model-specific mounting hardware.|GPR:https://www.gprstabilizer.com/products/",
    scotts: "Rotary steering stabilizer mounted in the stem/handlebar area, typically used with bike-specific mounting kits.|Scotts:https://www.scottsonline.com/scotts.php",
    generic: "Linear = rod-type damper mounted across the front end; Rotary = compact stabilizer mounted in the stem/handlebar area.|Info:https://engineerfix.com/what-does-a-steering-stabilizer-do-on-a-motorcycle/",
  },
  {
    feature: "Damping Principle",
    maxracing: "Rotary hydraulic damping that resists steering rotation by metering oil through internal valving as the bars turn.|FAQ:/faq",

    ohlins: "Piston-driven hydraulic damping that adds steering resistance by forcing oil through internal passages with adjustable valving (model-dependent pressurization).|Öhlins:https://ohlins.pl/sites/default/files/om_07261-01.pdf",
    hyperpro: "Piston-driven hydraulic damping; RSC variants add a more progressive response during rapid, high-speed steering movements.|Hyperpro:https://hyperpro.com/steering-dampers/",
    gpr: "Rotary hydraulic damping that resists steering rotation using internal valving, with separate control for low-speed vs high-speed steering events (model-dependent).|GPR:https://www.gprstabilizer.com/products/",
    scotts: "Rotary hydraulic damping that resists steering rotation using internal valving, with separate control for low-speed vs high-speed steering events (model-dependent).|Scotts:https://www.scottsonline.com/scotts.php",
    generic: "Most steering stabilizers use hydraulic damping (oil + valving) in either linear (rod) or rotary (stem/handlebar) layout.|Info:https://engineerfix.com/what-does-a-steering-stabilizer-do-on-a-motorcycle/",
  },
  {
