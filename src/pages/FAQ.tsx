...
const DEFAULT_FAQ_DATA: FAQCategory[] = [
  {
    ...
    items: [
      ...
      { question: "How long can I expect a MaxRacing damper to last?", answer: "MaxRacing dampers are engineered for long-term durability. We have numerous reports from long-term customers who have been using the same equipment for more than 15 years. Because every unit is rebuildable, periodic maintenance of seals and oil ensures a lifespan that can match the life of your motorcycle." },
      { question: "Are MaxRacing parts made locally or overseas?", answer: "MaxRacing components are engineered and assembled by our specialized teams, ensuring that every damper meets our strict internal tolerances before it reaches your machine." },
